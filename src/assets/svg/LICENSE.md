...
| ------------------------------------------------------------------------------ | ------------------ | ----------------------------------- | ------------------------------------------------------------------------------------- |
| `ajax.svg`, `asset.svg`, `bolt.svg`, `brand-css3.svg`, `chevron-down.svg`, `chevron-up.svg`, `chevrons-down.svg`, `chevrons-up.svg`, `config.svg`, `db.svg`, `history.svg`, `link.svg`, `moon.svg`, `profiling.svg`, `sun.svg`, `timeline.svg`, `user.svg` | Tabler Icons       | MIT                                 | <https://github.com/tabler/tabler-icons>                                              |
