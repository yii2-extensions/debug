...
final class TimelineRendererTest extends TestCase
{
    ...
    {
        $panel = $this->makePanel(100.0, 1048576);
    ...
    {
        $panel = $this->makePanel(123.456, 2 * 1048576);
    ...
    private function makePanel(float $duration, int $memory): TimelinePanel
    {
