...
/**
 * Stand-in for the framework-neutral Inertia page payload used by current adapter releases.
 */
final readonly class Page implements JsonSerializable
{
    ...
    /**
     * @return array<string, mixed> Serialized page payload mirroring the portable core shape.
     */
